...
export function Layout() {
  ...
  const openCaptchaModal = useAppSelector(
    (state) => state.auth.openCaptchaModal
  );
  const openRegistrationModal = useAppSelector(
  ...
  const billingAccountId = useAppSelector(
  ...
  const [eventsAnchorEl, setEventsAnchorEl] =
  ...
  const handleClick = () => {
    if (location.pathname === "/") {
      ...
      const steps: StepType[] =
        stepsMap[location.pathname as keyof typeof stepsMap];
                        ...
                        >
                          <Typography
                            ...
                            sx={{
                              ...
                              alignItems: "center",
                              gap: "7px",
                              color: isDocsPage ? "white" : undefined,
                            }}
                          >
