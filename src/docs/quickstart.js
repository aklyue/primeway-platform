...
const Quickstart = () => {
  ...
  const sections = [
    ...
    { id: "step-12", label: "Шаг 12: Повторный запуск задачи с новыми данными" },
      ...
      <Box sx={{ flexGrow: 1, paddingRight: isMobile ? "0" : "20px" }}>
        ...
        <ul>
          <li>
            ...
            например, когда вы получаете новый набор данных, и запускаете дообучение модели на нем.
          </li>
          <li>
...
ignore_patterns:
  ...
  - '*.egg-info'`}
        ...
        <p>
          <code>--output-dir output_directory/</code>: Директория, куда вы хотите сохранить выходные файлы.
        </p>
        <h3>Пример:</h3>
        <CodeBlock
