export const stepsMap = {
  ...
  "/tabby": [
    {
      selector: '[data-tour-id="tabby-create-btn"]',
      content:
        "Теперь, когда вы создали сессию, вы всегда можете создать новую нажав по кнопке.",
    },
    {
      selector: '[data-tour-id="sessions"]',
      content: "В этом разделе находятся все ваши сессии. Давайте ознакомимся с ними детальнее.",
    },
    {
      selector: '[data-tour-id="session"]',
      content:
        "Здесь находится вся основная информация по вашей сессии, а именно - имя, Code Gen id, Embedding id, статус сессии, URL, по которому вы можете зайти на админ-панель Tabby и кнопки запуска/остановки сессии.",
    },
    {
      selector: '[data-tour-id="url"]',
      content: "Давайте попробуем перейти на админ-панель вашей сессии для дальнейшей настройки и подключения к IDE (см. раздел Tabby в документации).",
    },
  ],
};
