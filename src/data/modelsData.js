...
export const modelsData = [
    {
      ...
      type: 'LLM',
      description: 'T-lite-it-1.0 — это модель, созданная на базе семейства моделей Qwen 2.5. Предварительный этап обучения 1: 100 млрд токенов. Предварительный этап обучения 2: 40 млрд токенов',
      defaultConfig: {
        ...
        modelConfig: {
          ...
          env: [
            {"name": "HUGGING_FACE_HUB_TOKEN", "value": "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"}
          ],
          schedule: {
            workdays: [],
            weekends: [],
    ...
    },
    {
      ...
      type: 'LLM',
      description: 'Модели Gemma 3 являются многомодальными, обрабатывают ввод текста и изображений и генерируют текстовый вывод, с открытыми весами как для предварительно обученных вариантов, так и для вариантов, настроенных на основе инструкций.',
      defaultConfig: {
    ...
    },
    {
      ...
      type: 'LLM',
      description: 'Модели DeepSeek-R1-Distill дообученны на основе моделей с открытым исходным кодом с использованием примеров, созданных DeepSeek-R1.',
      defaultConfig: {
