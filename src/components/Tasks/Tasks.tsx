                            ...
                            <Typography variant="body2" sx={{ mb: 0.5 }}>
                              ...
                              <span
                                style={{
                                  color:
                                    buildStatusColors[
                                      job.build_status as keyof typeof buildStatusColors
                                    ] || "black",
                                }}
                              >
                                {job.build_status}
                            ...
                            <Typography variant="body2">
                              ...
                              <span
                                style={{
                                  color:
                                    statusColors[
                                      job.last_execution_status as keyof typeof statusColors
                                    ] || "black",
                                }}
                              >
          ...
          {executionsLoading ? (
            ...
            <Box>
              {currentExecutions.map((execution) => {
                ...
                const logsData =
                  logsByExecutionId[
                    executionId as keyof typeof logsByExecutionId
                  ];
                return (
          ...
          {scheduleLoading ? (
            ...
            <Box>
              <Typography variant="body1">
                <strong>Начало:</strong>{" "}
                {currentScheduleData.start_time &&
                  formatDateTime(currentScheduleData.start_time)}
              </Typography>
              <Typography variant="body1">
                <strong>Конец:</strong>{" "}
                {currentScheduleData.end_time &&
                  formatDateTime(currentScheduleData.end_time)}
              </Typography>
              <Typography variant="body1">
