...
import { Job, Model, ModelConfig } from "../../types";

interface SpecificModelPageState {
  model: Job;
  initialConfig: Model;
  isBasic: boolean;
  isMobile: boolean;
...
function SpecificModelPage() {
  ...
  const state = location.state as SpecificModelPageState;
  const { model, initialConfig, isBasic, isMobile, isTablet } = state || {};
