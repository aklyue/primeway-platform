      ...
      <Box sx={{ flexGrow: 1, paddingRight: isMobile ? "0" : "10px" }}>
        ...
        <div style={{ marginTop: "20px", marginBottom: "20px" }}>
          ...
          <p>
            ...
            эффективные GPU-ресурсы в ваше распоряжение.
          </p>
          ...
          <ul>
            ...
            <li>
              <strong>Масштабируемость</strong>: Легко масштабируйте ваши рабочие
              нагрузки с помощью функции автоматического масштабирования —
            ...
            <li>
              ...
              через нашу интуитивно понятную веб-платформу или интерфейс командной
              строки.
            </li>
            <li>
            ...
            <li>
              <strong>Удобство для разработчиков</strong>: Бесшовная интеграция с
              вашими существующими инструментами и рабочими процессами.
            </li>
          </ul>
          ...
          >
            ...
            >
              ...
              >
                <h3>Быстрый старт</h3>
                <p>
                  Начните работать с PrimeWay: узнайте, как развернуть ваше первое
          ...
          <h2 id="join-community" style={{ marginTop: "60px" }}>
            Присоединяйтесь к сообществу
          </h2>
          <p>
            Мы больше, чем просто платформа; мы — сообщество новаторов и решателей
            проблем. Свяжитесь с другими пользователями PrimeWay, чтобы поделиться
            идеями, задать вопросы и сотрудничать над проектами.
          </p>
          <ul>
            <li>
              <strong>Форумы поддержки</strong>: Посетите наши{" "}
              <a href="https://primeway.example.com/community">сообщества</a>,
              чтобы общаться с другими пользователями и нашей командой поддержки.
            </li>
            <li>
              <strong>Документация</strong>: Доступ к подробным руководствам и
              справочникам API в нашей{" "}
              <a href="https://primeway.example.com/docs">документации</a>.
            </li>
            <li>
              <strong>Поддержка клиентов</strong>: Свяжитесь с нами по адресу{" "}
              <a href="mailto:support@primeway.ru">support@primeway.ru</a> для
              персональной помощи.
            </li>
          </ul>
