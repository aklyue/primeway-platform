...
import { getOrgMembers, addOrgMember, removeOrgMember } from "../../api";
...
const OrganizationSettings = () => {
  ...
  const isCurrentOrgOwner = useAppSelector(selectIsCurrentOrgOwner);
  ...
  const [error, setError] = useState<string | null>(null); // Объединенное состояние ошибок
