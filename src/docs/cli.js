    ...
    <Box sx={{ display: "flex" }}>
      <Box sx={{ flexGrow: 1, paddingRight: "20px" }}>
        ...
        <section id="installation-and-setup">
          ...
          <CodeBlock code={`primeway --version`} />
        </section>
        ...
        <section id="authentication">
          ...
          <CodeBlock code={`primeway_api_token: primeway-nlOm2e3vwv_rjakw286mzg`} />
        </section>
        ...
        <section id="command-reference">
          ...
          <section id="job-commands">
            ...
            <CodeBlock code={`primeway run job JOB_ID`} />
            <p><strong>List Jobs:</strong></p>
            <CodeBlock code={`primeway job list`} />
            <p><strong>Get Job Details:</strong></p>
            <CodeBlock code={`primeway job info JOB_ID`} />
            <p><strong>Get Job Logs:</strong></p>
            <CodeBlock code={`primeway job logs JOB_ID`} />
            <p><strong>Get Job Artifacts:</strong></p>
            <CodeBlock code={`primeway job artifacts JOB_ID --output-dir ./artifacts`} />
            <p><strong>Stop a Job:</strong></p>
            <CodeBlock code={`primeway stop job --job-id JOB_ID`} />
          </section>
          ...
          <section id="pipeline-commands">
            ...
            <CodeBlock code={`primeway create pipeline --config pipeline_config.yaml`} />
            <p><strong>Run a Pipeline:</strong></p>
            <CodeBlock code={`primeway run pipeline PIPELINE_ID`} />
            <p><strong>List Pipelines:</strong></p>
            <CodeBlock code={`primeway pipeline list`} />
            <p><strong>List Pipeline Executions:</strong></p>
            <CodeBlock code={`primeway pipeline executions PIPELINE_ID`} />
            <p><strong>Get Pipeline Execution Details:</strong></p>
            <CodeBlock code={`primeway pipeline execution-info EXECUTION_ID`} />
          </section>
        </section>
        ...
        <section id="using-the-cli-interactively">
          ...
          <CodeBlock code={`primeway run job --help`} />
        </section>
      </Box>
