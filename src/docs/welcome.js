    ...
    <Box sx={{ display: "flex", flexDirection: isMobile ? "column" : "row" }}>
      <Box sx={{ flexGrow: 1, paddingRight: isMobile ? "0" : "10px" }}>
        ...
        <div style={{ marginTop: "20px", marginBottom: "20px" }}>
          ...
          <p>
            Мы больше, чем просто платформа; мы — сообщество новаторов и
            решателей проблем. Свяжитесь с другими пользователями PrimeWay,
            чтобы поделиться идеями, задать вопросы и сотрудничать над
            проектами.
          </p>
          <ul>
            <li>
              ...
              чтобы общаться с другими пользователями и нашей командой
              поддержки.
            </li>
            <li>
