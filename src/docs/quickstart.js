    ...
    <Box sx={{ display: "flex", flexDirection: isMobile ? "column" : "row" }}>
      ...
      >
        ...
        <section id="key-concepts">
          ...
          <ul>
            ...
            <li>
              ...
              постоянные API сервисы. Они продолжают работать и могут
              обслуживать запросы в реальном времени, как например, деплой LLM
              модели с помощью vllm.
            </li>
          </ul>
        </section>
        ...
        <section id="step-2">
          ...
          <p>
            <strong>Сгенерируйте Секретный-ключ:</strong> Нажмите на создать
        ...
        <section id="step-3">
          ...
          <p>
            <strong>Перейдите в раздел платежей:</strong> Зайдите в свой
            кошелек.
          </p>
          <p>
        ...
        <section id="step-5">
          ...
          <p>
            Добавьте API-токен непосредственно в ваш файл конфигурации под
            ключом <code>primeway_api_token</code>:
          </p>
          <CodeBlock
            code={`primeway_api_token: ВАШ_API_КЛЮЧ`}
            language="yaml"
          />
          <p
            style={{
...
`}
          ...
          <ul>
            ...
            <li>
              <code>job_type</code>: Используйте <code>run</code> для
              одноразовых задач или <code>deploy</code> для постоянных сервисов.
            </li>
            <li>
            ...
            <li>
              <code>requirements</code>: Список Python-пакетов, необходимых
              вашему приложению.
            </li>
            <li>
        ...
        <section id="step-8">
          ...
          <p>
            <strong>Вывод:</strong> Команда выдаст <code>JOB_ID</code>, который
            вы будете использовать для запуска задачи.
          </p>
        </section>
        ...
        <section id="step-10">
          ...
          />
          <p>
            <code>JOB_EXECUTION_ID</code>: ID конкретного запуска задачи,
            который вы получите при выполнении <code>primeway run job</code>.
          </p>
          <p>
        ...
        <section id="tips">
          ...
          <ul>
            ...
            <li>
              <strong>Повторное использование задач:</strong> Создайте задачу
              один раз и запускайте её несколько раз с разными данными по мере
              необходимости.
            </li>
          </ul>
        </section>
        ...
        <section id="troubleshooting">
          ...
          <ul>
            <li>
              <strong>Ошибки аутентификации:</strong> Убедитесь, что ваш
              API-ключ правильно настроен через <code>.env</code> файл,
              переменную окружения или в файле конфигурации.
            </li>
            <li>
            ...
            <li>
              <strong>Сбои задачи:</strong> Проверьте логи на наличие сообщений
              об ошибках и скорректируйте код приложения или конфигурацию.
            </li>
            <li>
        ...
        <section id="support">
          ...
          <ul>
            <li>
              <strong>Форумы поддержки:</strong> Присоединяйтесь к обсуждениям
              на сообществе PrimeWay.
            </li>
            <li>
        ...
        <section id="additional-notes">
          ...
          <ul>
            <li>
              ...
              контейнеризацию на стороне сервера. Вам нужно только указать
              базовый образ Docker и зависимости вашего приложения.
            </li>
            <li>
              <strong>Повторный запуск задач с новыми данными:</strong> Вы
              можете запускать задачу несколько раз с разными наборами данных,
              указывая опцию <code>--data-file</code>.
            </li>
          </ul>
        </section>
      </Box>
